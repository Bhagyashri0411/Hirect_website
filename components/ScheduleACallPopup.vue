<template>
    <div>
        <div class="schedule-a-call">
            <p class="schedule-title">Connect with 3M+ verified jobseekers</p>
            ...
            <div class="input-container">
                <el-input id="user-email" v-model="getUserInf.userEmail" @focus="inputFocus(3)"
                    placeholder="Your Work Email" class="input-item" />
            ...
            <div class="bulk-hiring"><a style="color: #015a5b !important;" href="/enterprise-hiring">Have
        ...
        <el-dialog :visible.sync="dialogVisible" width="920px" :append-to-body="true" class="submit-dialog">
            <center>
                ...
                <div class="download-container">
                    <img src="~/assets/img/btn_appstore.png" loading="lazy" alt="btn_appstore"
                        @click="appImgClickHandle" class="download_btn" />
                    <img src="~/assets/img/btn_googleplay.png" loading="lazy" alt="btn_googleplay"
