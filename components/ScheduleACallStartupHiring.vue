...
<div>
    <div class="schedule-a-call">
        ...
        <div class="input-container">
            <el-input id="user-name" v-model="getUserInf.userName" @focus="inputFocus(1)" placeholder="Your Name" class="input-item" />
            <p v-show="isUserNameError" class="alertText">Your name is required</p>
        </div>
        <div class="input-container">
            <el-input id="phone-number" v-model="getUserInf.phoneNumber" @focus="inputFocus(2)" maxlength="10" placeholder="Enter 10 digit mobile number" class="input-item">
        ...
        <div class="input-container">
            <el-input id="user-email" v-model="getUserInf.userEmail" @focus="inputFocus(3)" placeholder="Your Work Email" class="input-item" />
            <p v-show="isUserEmailError" class="alertText">Your work email is required</p>
        </div>
        <div class="input-container">
            <el-input id="company-name" v-model="getUserInf.userCompanyName" @focus="inputFocus(4)" placeholder="Your Company Name" class="input-item" />
            <p v-show="isCompanyNameError" class="alertText">Your company name is required</p>
        </div>
        <div class="input-container">
            <el-select id="user-position" v-model="getUserInf.userPosition" @focus="inputFocus(5)" class="input-item" placeholder="Your Position">
        ...
        <el-checkbox v-model="getUserInf.isReceive" class="schedule-checkbox" style="color:#78787A;">I'm neither a job seeker nor a hiring consultant.</el-checkbox>
    </div>
    <el-dialog :visible.sync="dialogVisible" width="920px" class="submit-dialog">
        <center>
            ...
            <p class="dialog_text">We will get in touch with you in 30 minutes. Meanwhile,<br>scan the QR code to<span style="font-weight:bolder;"> download the app!</span></p>
