    ...
    <div class="modal" @click.stop>
      <div class="download-form">
        <div class="download-form-field">
          ...
          <el-button type="primary" class="btn default-btn button-sm" :loading="isButtonLoading" @click="sendSms">Text Me The Link</el-button>
        </div>
        <span v-if="isMobileError" class="alertText" :class="errorClass">{{ errorMsg }}</span>
      </div>
      <p>
        Scan the QR code below to download the
        <span style="color: #2ce2a2">Hirect App</span>
      </p>
      <div class="app-scan-button">
        ...
        <a
          ...
          target="_blank"
          ><img
            src="~/assets/imgs/logo_apple-store.png"
            loading="lazy"
            alt="android-badge"
        /></a>
        <span
        ...
        <a
          ...
          target="_blank"
          ><img
            src="~/assets/imgs/logo-google-playstore.png"
            loading="lazy"
            alt="ios-badge"
        /></a>
      </div>
...
export default {
  ...
  methods: {
    async sendSms() {
      ...
      this.errorMsg = await this.$sendAppLink(
