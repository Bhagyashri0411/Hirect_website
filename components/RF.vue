<template>
  <div style=" box-shadow: 0px 1px 26px 1px #80808040;">
    <div class="schedule-a-call contact-ue-form">
      <p class="schedule-title">Let us Simplify the Hiring Process</p>
      <p class="schedule-sub-title">Register to find your Next Hire. Get Started Soon.</p>
      ...
      <div class="input-container">
        <el-input id="phone-number" v-model="getUserInf.phoneNumber" @focus="inputFocus(2)" maxlength="10"
          placeholder="10-digit mobile number" class="input-item">
      ...
      <el-checkbox v-model="getUserInf.isReceive" class="schedule-checkbox" style="color: #78787a; margin-left: 10px;">
        <div style="font-size:11px;">I
          would like to receive updates via WhatsApp.</div>
      </el-checkbox>

      <el-button type="primary" class="submitButton" :loading="isButtonLoading" @click="submitClick">Submit
      </el-button>
    </div>
    <el-dialog :visible.sync="dialogVisible" width="920px" :append-to-body="true" class="submit-dialog">
      <center>
        <img src="~/assets/img/ic_congratulations.png" loading="lazy" alt="ic_congratulations"
        ...
        <div class="download-container">
          <img src="~/assets/img/btn_appstore.png" loading="lazy" alt="btn_appstore" @click="appImgClickHandle"
            class="download_btn" />
