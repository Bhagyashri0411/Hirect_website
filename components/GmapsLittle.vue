<template>
  <div>
    ...
    <remote-js js-url="https://maps.googleapis.com/maps/api/js?&key=AIzaSyCxUAZ3vLOBjYnVkacfPIPc8mVJ5MzoXGo"
...
export default {
  ...
  methods: {
    loadRongJs() {
      ...
      const map = new window.google.maps.Map(document.getElementById('GmapsLittle'), options);
