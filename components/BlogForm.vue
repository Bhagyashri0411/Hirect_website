<template>
    <div>
        <div class="schedule-a-call contact-ue-form">
            <p class="schedule-text">Recruiters</p>
            ...
            <div class="input-container">
                <el-input id="user-email" v-model="getUserInf.userEmail" @focus="inputFocus(3)"
                    placeholder="Official Email" class="input-item" />
            ...
            <div class="input-container-bottom">
                ...
                <el-select id="user-position" v-model="getUserInf.userPosition" @focus="inputFocus(5)"
                    class="inner-input-item" placeholder="Designation">
            ...
            <el-checkbox v-model="getUserInf.isReceive" class="schedule-checkbox"
                style="color: #78787a; margin-left: 10px">I would like to receive updates via WhatsApp.</el-checkbox>
            ...
            <center>
                ...
                <div class="download-container">
                    ...
                    <div class="downloadDialog-button-pkg-container" @mouseover="downloadPkgMouseIn"
                        ...
                        <img src="~/assets/img/pkg_android.webp" class="downloadDialog-button-pkg"
                            @click="googlePkgClickHandle" loading="lazy" alt="google-play-badge" />
