<template>
  <div>
    <div class="download-guide-head">
      <img
        class="download-guide-head-logo"
        src="~/assets/img/hirect-logo-full.png"
        alt="hirect-logo"
      />
    </div>
    <center>
      <div class="download-guide-title">
        <p>How to install Hirect<br />without Google Play Store</p>
      </div>
    </center>
    <div class="download-guide-button-container">
      <img
        class="download-guide-button"
        src="~/assets/img/download-guide-button.png"
        alt="download-guide-button"
      />
      <p class="download-guide-button-text">Check out the following guide</p>
    </div>
    <img
      class="download-guide-arrow"
      src="~/assets/img/download-guide-arrow.png"
      alt="download-guide-arrow"
    />
    <div
      class="download-guide-img-item"
      data-aos="fade-up"
      v-for="(item, index) of guideImgs"
      :style="item.imgStyle"
    >
      <img
        class="download-guide-img"
        :src="item.imgSrc"
        :style="item.imgStyle"
        alt="download-guide-img"
      />
    </div>
  </div>
</template>
...
.download-guide-head {
  ...
  height: 80px;
  background: #ffffff;
  box-shadow: 0px 10px 20px 0px rgba(227, 227, 227, 0.25);
  display: flex;
  align-items: center;
  justify-content: center;

  .download-guide-head-logo {
    width: 150px;
    height: 40px;
  }
}
...
.download-guide-button-container {
  position: relative;
  margin: 0 auto;
  width: 386px;
