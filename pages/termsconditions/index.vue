  ...
  <div class="wrapper">
    ...
    <div class="container privacy-policy-page">
      ...
      <p class="policy-item-desc">
        ...
        a different remote device, or generally utilise the Services without
        being registered) or you are a "Member" (which implies that you have
        registered with Hirect). The term "User" refers to a Visitor or a
        Member. Your download or use of the Services, regardless of whether your
        ...
        revise these Terms and policies at any time, and you agree to be bound
        by such modifications or revisions. It is, therefore, crucial that you
        review this Agreement regularly. If you disagree to be bound by this
        Agreement and abide by all Applicable Law (defined below), you are not
        authorised to use the applicable Services. You should delete the
      ...
      <p class="policy-item-desc">
        ...
        Job-Seekers, etc. We have no control over and assume no responsibility
        for any third-party websites' content, privacy policies, or practices.
        In addition, we will not and cannot censor or edit the content of any
        third-party site. By using the Service, you expressly relieve us from
      ...
      <p class="policy-item-desc">
        ...
        known, including, without limitation, on, through or in connection with
        the Services to third-party applications; widgets; websites; or mobile,
        desktop or other services which are linked with your Account, including,
        without limitation, distributing part or all of the Services and any
        Content included therein, in any media formats and through any media
        channels. You also hereby grant each User of the Service a non-exclusive
        licence to access your Content through the Services, and to use,
        reproduce, distribute, display, publish, make available online or
        electronically transmit, and perform such Content as permitted through
        the functionality of the Services and under these Terms. You shall be
        solely responsible for your Content and the consequences of submitting
        and publishing your Content on the Services. You affirm, represent, and
        warrant that you own or have the necessary licences, rights, consents,
        and permissions to publish Content you submit; and you licence to us all
        patent, trademark, trade secret, copyright or other proprietary rights
        in and to such Content for publication on the Services pursuant to these
        Terms, royalty-free.
      </p>
      ...
      <p class="policy-item-desc">
        ...
        racial, ethnically objectionable, impersonates another person; that
        which contains software viruses or any other computer code, filed or
        programs designed to interrupt, destroy or limit the functionality of
        any software resource; threatens the unity, integrity, defence, security
      ...
      <p class="policy-item-desc">
        ...
        Any such infringing Content is subject to the removal or blocking in
      ...
      <p class="policy-item-desc">
        ...
        Email or Direct Call. We may also contact you for feedback about your
        experience with Hirect and for taking part in various events and
        research organised by the Hirect team according to these Terms &
        Conditions.
      </p>
      ...
      <p class="policy-item-desc">
        ...
        to be verified. If the referral has been "Rejected", it means that this
        Referee has been rejected by our audit team because they don't qualify
      ...
      <ul class="list-style2">
        ...
        <li>
          All Hirect promotions are run for a limited time only and we reserve
          the rights to modify or amend these Terms and Conditions at any time
          and/or the methods through which rewards are earned;
        </li>
        <li>
          Hirect shall not be liable for your loss due to incomplete,
      ...
      <ul>
        ...
        <li>
          (iii) Use any system, bot or other device or artifice to participate
          or receive any benefit in the Program. Should such an attempt be made,
          the company reserves the right to seek remedies and damages to the
      ...
      <p class="policy-item-desc">
        ...
        payment terms that may apply, which are disclosed at the point of
      ...
      <p class="policy-item-desc">
        ...
        subsection entitled “Refunds” below) be eligible for a prorated refund,
      ...
      <p class="policy-item-desc">
        ...
        if you die before the end of your subscription period. Suppose you
        become disabled (so that you cannot use Hirect) before the end of your
        subscription period. In that case, you are entitled to a refund of that
        portion of your subscription payment transferable to the period after
      ...
      <p class="policy-item-desc">
        ...
        received notification of your decision to cancel the Agreement. we shall
        make such a refund using the same means of payment as used by you in the
      ...
      <p class="policy-item-desc">
        ...
        and in our sole discretion, remove such Content and/or terminate a
...
.terms-table .table tr th {
  color: #808080;
}

.terms-table .table tr th h3 {
  font-size: 20px;
  text-align: center;
  font-weight: bold;
}

.terms-table .table tr td h4 {
  color: grey;
  font-size: 20px;
  text-align: center;
}
...
.terms-table table.table.table-bordered {
  border-color: #000;
  margin-bottom: 8px;
}
