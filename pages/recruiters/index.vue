              ...
              <div class="px-0.5 py-0.5">
                <div class="recruiter-banner-details">
                  ...
                  <p>
                    ...
                    startups who are pleased to be a part of the startup
                    ecosystem hiring on this job portal website. Since zero
                    consultants are involved, it eliminates any spam or scam
                    calls, and the entire recruitment process is 100% secure.
                  </p>
                ...
                <ul class="startups-logo-list">
                  <li>
                    <div class="features-title">
                      Chat Directly and Get <br />Instant Response
                    </div>
                  </li>
                  <li>
                    <div class="features-title">
                      AI- Algorithm <br />Matched Candidates
                    </div>
                  </li>
                  <li>
                    <div class="features-title">
