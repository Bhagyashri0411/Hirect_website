  ...
  <div class="wrapper">
    ...
    <section class="top-talent-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="title-sm">Trending IT Categories in Bangalore</h3>
            <div class="jobs-list">
              <ul class="available-list">
                <li>
                  <span
                    ><span>Angular JS</span> <br /><br /><span
                      class="candi-value"
                      >10K Candidate</span
                    ></span
                  >
                ...
                <li>
                  <span
                    >CSS<br /><br /><span class="candi-value"
                      >9K Candidate
                    </span></span
                  >
                </li>
                <li>
                  <span
                    >HTML<br /><br /><span class="candi-value"
                      >8K Candidate
                    </span></span
                  >
                </li>
                <li>
                  <span
                    >Bootstrap <br /><br />
                    <span class="candi-value">7K Candidate </span></span
                  >
                </li>
                <li>
                  <span
                    >+More <br /><br /><span class="candi-value"
                      >+100K Candidate</span
                    ></span
                  >
                </li>
          ...
          <div class="col-md-12">
            ...
            <div class="jobs-list">
              <ul class="available-list">
                <li>
                  <span
                    ><span>Design</span> <br /><br /><span class="candi-value"
                      >10K Candidate</span
                    ></span
                  >
                </li>
                <li>
                  <span
                    >Sales<br /><br /><span class="candi-value"
                      >10K Candidate
                    </span></span
                  >
                </li>
                <li>
                  <span
                    >Operation<br /><br /><span class="candi-value"
                      >10K Candidate
                    </span></span
                  >
                </li>
    ...
    <section class="other-top-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h3 class="title-sm">Other top Cities for IT Engineer in India</h3>
            <div class="jobs-list">
              <ul class="available-list">
                <li>
                  <span
                    ><span>Hyderabad</span> <br /><br /><span
                      class="candi-value"
                      >10K Candidate</span
                    ></span
                  >
                ...
                <li>
                  <span
                    >Delhi-NCR<br /><br /><span class="candi-value"
                      >10K Candidate
                    </span></span
                  >
                </li>
                <li>
                  <span
                    >Pune<br /><br /><span class="candi-value"
                      >10K Candidate
                    </span></span
                  >
                </li>
