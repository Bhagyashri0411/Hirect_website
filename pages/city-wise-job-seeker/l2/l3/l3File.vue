<!-- <template>
    <div class="wrapper">
        <Header />
        <section class="form-search-section">
            <div class="col-md-12">
                <div class="form-search">
                        ...
                        <div class="MuiAutocomplete-fullWidth" role="combobox" aria-expanded="false">
                            <div class="location">
                                <svg width="16" height="14" viewBox="0 0 18 16" fill="none"
                                    ...
                                    <rect x="0.75" y="3.5" width="16.5" height="11.5" rx="1.375" stroke="#0E101A" />
                                    <path
                    ...
                    <div class="autocomplete">
                        <div class="MuiAutocomplete-fullWidth" role="combobox" aria-expanded="false">
                            <div class="location" style="border-right: 0">
                                <svg width="16" height="16" style="margin-left: 10px" viewBox="0 0 20 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="autocomplete">
                        <button type="button" class="start-hiring1">Start Hiring</button>
                    </div>
                </div>
            </div>
        </section>
        <section class="top-talent-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-sm">Trending {{  $route.params.l2Value  }} Categories in Bangalore</h3>
                        <div class="jobs-list">
                            <ul class="available-list">
                                <li v-for="(item, index) in l2[$route.params.l2Value]" :key="l2.id">
                                    <span><span>{{  index  }}</span> <br /><br /><span class="candi-value">10K
                                            Candidate</span></span>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="trending-cat-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-sm">Trending Categories across Bangalore</h3>
                        <div class="jobs-list">
                            <ul class="available-list">
                                <li>
                                    <span><span>Design</span> <br /><br /><span class="candi-value">10K
                                            Candidate</span></span>
                                </li>
                                <li>
                                    <span>Sales<br /><br /><span class="candi-value">10K Candidate
                                        </span></span>
                                </li>
                                <li>
                                    <span>Operation<br /><br /><span class="candi-value">10K Candidate
                                        </span></span>
                                </li>
                                <li>
                                    <span>Product Management <br /><br />
                                        <span class="candi-value">10K Candidate </span></span>
                                </li>
                                <li>
                                    <span>+More <br /><br /><span class="candi-value">+100K Candidate</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="other-top-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title-sm">Other top Cities for {{  $route.params.l2Value  }} in India</h3>
                        <div class="jobs-list">
                            <ul class="available-list">
                                <li>
                                    <span><span>Hyderabad</span> <br /><br /><span class="candi-value">10K
                                            Candidate</span></span>
                                </li>
                                <li>
                                    <span>Delhi-NCR<br /><br /><span class="candi-value">10K Candidate
                                        </span></span>
                                </li>
                                <li>
                                    <span>Pune<br /><br /><span class="candi-value">10K Candidate
                                        </span></span>
                                </li>
                                <li>
                                    <span>Mumbai <br /><br />
  ...
  <script>
import l2 from '../../functional-area.json';
